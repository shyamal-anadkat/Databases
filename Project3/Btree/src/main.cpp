...
void intTestsFileLoad() {
  BTreeIndex* index = new BTreeIndex(relationName, intIndexName, bufMgr,
  ...
  checkPassFail(intScan(index, 25, GT, 40, LT), 14)
      checkPassFail(intScan(index, 20, GTE, 35, LTE), 16)
          checkPassFail(intScan(index, 3000, GTE, 4000, LT), 1000)
              ...
              delete index;
  index = new BTreeIndex(relationName, intIndexName, bufMgr, offsetof(tuple, i),
                         INTEGER);
  ...
  checkPassFail(intScan(index, 25, GT, 40, LT), 14)
          checkPassFail(intScan(index, 20, GTE, 35, LTE), 16)
              checkPassFail(intScan(index, 3000, GTE, 4000, LT), 1000)
                  ...
                  std::cout
      << "Success: intTestsFileLoad Passed." << std::endl;
  delete index;
  File::remove(intIndexName);
}
